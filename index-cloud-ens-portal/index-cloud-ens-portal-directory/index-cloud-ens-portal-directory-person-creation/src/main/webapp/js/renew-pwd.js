...
$JQry(function() {
	...
	$JQry(".renew-password input[name=newpassword]").each(function(index, element) {
	...
	function updatePasswordRulesInformation() {
		var $placeholder = $JQry(".renew-password [data-password-information-placeholder]");
		var $input = $JQry(".renew-password input[name=newpassword]");
