 ...
 * 
 */
package fr.index.cloud.ens.directory.person.renew.portlet.configuration;
 ...
 */
@Configuration
@ComponentScan(basePackages = "fr.index.cloud.ens.directory.person.renew.portlet")
public class RenewPasswordPortletCfg  extends CMSPortlet {
    ...
    public InternalResourceViewResolver getViewResolver() {
        ...
        viewResolver.setPrefix("/WEB-INF/renew-password/jsp/");
